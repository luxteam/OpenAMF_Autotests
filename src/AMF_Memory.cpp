...
TEST_F(AMF_Memory, DISABLED_getDataTypeFromMemoryUnknown) {
	...
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_ANY_THROW(variables.smartptr->GetDataType());
}
...
TEST_F(AMF_Memory, getExpectedDataBufferType) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetDataType(), AMF_DATA_BUFFER);
}
...
TEST_F(AMF_Memory, getExpectedDataSurfaceType) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	//EXPECT_NE(variables.surface, nullptr);
	//EXPECT_EQ(variables.res, AMF_OK);
	//EXPECT_EQ(variables.surface->GetDataType(), AMF_DATA_SURFACE);
}
...
TEST_F(AMF_Memory, getExpectedDataAudioBufferType) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	//EXPECT_NE(variables.aubuf, nullptr);
	//EXPECT_EQ(variables.res, AMF_OK);
	//EXPECT_EQ(variables.aubuf->GetDataType(), AMF_DATA_AUDIO_BUFFER);
}
...
TEST_F(AMF_Memory, getExpectedMemoryHostType) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetMemoryType(), AMF_MEMORY_HOST);
}
//todo
TEST_F(AMF_Memory, DISABLED_getExpectedMemoryTypeOpenCL){
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetMemoryType(), AMF_MEMORY_OPENCL);
}
...
TEST_F(AMF_Memory, DISABLED_convertMemoryHostToMemoryOpencl) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NE(variables.smartptr->GetDataType(), AMF_MEMORY_OPENCL);
}
 ...
 TEST_F(AMF_Memory, interopMemoryHostToMemoryOpencl) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetDataType(), AMF_MEMORY_HOST);
}
...
TEST_F(AMF_Memory, checkDataObjectIsReusable) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->IsReusable(), true);
}
...
TEST_F(AMF_Memory, setPtsDontCrash) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->SetPts(3000));
}
...
TEST_F(AMF_Memory, getPtsDontCrash) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->GetPts());
}
...
TEST_F(AMF_Memory, getPtsWithSetPtsChecking) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->SetPts(3333));
	//variables.smartptr->SetPts(3333);
	EXPECT_EQ(variables.smartptr->GetPts(), 3333);
}
...
TEST_F(AMF_Memory, setDurationDontCrash) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->SetDuration(3000));
}
...
TEST_F(AMF_Memory, getDurationDontCrash) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->GetDuration());
}
...
TEST_F(AMF_Memory, getDurationWithSetDurationChecking) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->SetDuration(3333));
	//variables.smartptr->SetDuration(3333);
	EXPECT_EQ(variables.smartptr->GetDuration(), 3333);
}
...
TEST_F(AMF_Memory, bufferSetSizeDontCrashWithSizeMoreThanAllocated) {
	...
	EXPECT_EQ(variables.res, AMF_INVALID_ARG);
	EXPECT_NE(variables.smartptr, nullptr);
}
...
TEST_F(AMF_Memory, bufferGetSizeWithCorrectSize) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetSize(), 1024 * sizeof(float));
	variables.res = variables.smartptr->SetSize(512 * sizeof(float));
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_EQ(variables.smartptr->GetSize(), 512 * sizeof(float));
}
...
TEST_F(AMF_Memory, bufferGetNativeWithMemoryHost) {
	...
	EXPECT_NO_THROW(native = static_cast<AMFBuffer*>(variables.smartptr->GetNative()));
...
TEST_F(AMF_Memory, DISABLED_bufferAddObserverThworsNothing) {
	...
	EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.smartptr, nullptr);
	EXPECT_NO_THROW(variables.smartptr->AddObserver(obs));
}
...
TEST_F(AMF_Memory, DISABLED_bufferRemoveObserverThworsNothing) {
	...
	EXPECT_NO_THROW(variables.smartptr->RemoveObserver(obs));
}
...
TEST_F(AMF_Memory, audioBufferGetSize) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NE(variables.aubuf, nullptr);
	* EXPECT_EQ(variables.aubuf->GetSize(), 1024 * sizeof(amf_int32));
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetNativeWithMemoryHost) {
	...
	* EXPECT_NE(variables.aubuf, nullptr);
	* EXPECT_EQ(native, nullptr);
	* EXPECT_NO_THROW(native = static_cast<AMFBuffer*>(variables.aubuf->GetNative()));
	* EXPECT_NE(native, nullptr);
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetSampleCount) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NO_THROW(variables.aubuf->GetSampleCount());
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetSampleRate) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NO_THROW(variables.aubuf->GetSampleRate());
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetSampleSize) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NO_THROW(variables.aubuf->GetSampleSize());
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetChannelCount) {
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NO_THROW(variables.aubuf->GetChannelCount());
	*/
}
...
TEST_F(AMF_Memory, audioBufferGetChannelLayout) { 
	...
	EXPECT_EQ(variables.res, AMF_NOT_IMPLEMENTED);
	/*EXPECT_EQ(variables.res, AMF_OK);
	* EXPECT_NO_THROW(variables.aubuf->GetChannelLayout());
	*/
}
...
TEST_F(AMF_Memory, audioBufferAddObserverThworsNothing) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.aubuf, nullptr);
	EXPECT_NO_THROW(variables.aubuf->AddObserver(aobs));
	*/
}
...
TEST_F(AMF_Memory, audioBufferRemoveObserverThworsNothing) {
	...
	EXPECT_NO_THROW(variables.aubuf->RemoveObserver(aobs));
	*/
}
...
TEST_F(AMF_Memory, surfaceGetFormat) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_EQ(variables.surface->GetFormat(), AMF_SURFACE_NV12);
	*/
}
...
TEST_F(AMF_Memory, surfaceGetPlanesCount) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->GetPlanesCount());
	*/
}
...
TEST_F(AMF_Memory, surfaceGetPlaneAt) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->GetPlaneAt(index));
	*/
}
...
TEST_F(AMF_Memory, surfaceGetPlane) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->GetPlane(type));
	*/
}
...
TEST_F(AMF_Memory, surfaceGetFrameType) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->GetFrameType());
	*/
}
...
TEST_F(AMF_Memory, surfaceSetFrameType) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->SetFrameType(type));
	*/
}
...
TEST_F(AMF_Memory, surfaceSetCrop) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->SetCrop(x, y, width, height));
	*/
}
...
TEST_F(AMF_Memory, surfaceAddObserverThworsNothing) {
	...
	/*EXPECT_EQ(variables.res, AMF_OK);
	EXPECT_NE(variables.surface, nullptr);
	EXPECT_NO_THROW(variables.surface->AddObserver(sobs));
	*/
}
...
TEST_F(AMF_Memory, surfaceRemoveObserverThworsNothing) {
	...
	EXPECT_NO_THROW(variables.surface->RemoveObserver(sobs));
	*/
}
...
TEST_F(AMF_Memory, planeGetType) {
	...
	* EXPECT_EQ(variables.plane->GetType(), type);
	*/
}
...
TEST_F(AMF_Memory, planeGetNative) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(native = static_cast<AMFBuffer*>(variables.plane->GetNative()));
	*/
}
...
TEST_F(AMF_Memory, planeGetPixelSizeLnBytes) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetPixelSizeLnBytes());
	*/
}
...
TEST_F(AMF_Memory, planeGetOffsetX) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetOffsetX());
	*/
}
...
TEST_F(AMF_Memory, planeGetOffsetY) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetOffsetY());
	*/
}
...
TEST_F(AMF_Memory, planeGetWidth) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetWidth());
	*/
}
...
TEST_F(AMF_Memory, planeGetHeight) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetHeight());
	*/
}
...
TEST_F(AMF_Memory, planeGetHPitch) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetHPitch());
	*/
}
...
TEST_F(AMF_Memory, planeGetVPitch) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->GetVPitch());
	*/
}
...
TEST_F(AMF_Memory, planeIsTiled) {
	...
	* EXPECT_NE(variables.surface, nullptr);
	* variables.plane = variables.surface->GetPlane(type);
	* EXPECT_NO_THROW(variables.plane->IsTiled());
	*/
}