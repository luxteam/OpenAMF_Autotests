...
TEST_F(Implementation, DISABLED_AMFFactory_CreateComponent) {
...
TEST_F(Implementation, DISABLED_AMFTrace_GetPath) {
	AMFTrace* trace;
	factory->GetTrace(&trace);
	amf_size* size;
	*size = (amf_size)30;
...
TEST_F(Implementation, AMFData_Duplicate) {
	AMFBuffer* buffer;
...
TEST_F(Implementation, DISABLED_AMFData_Convert) {
	AMFBuffer* buffer;
	AMFBuffer* buffer_res;
	context1->AllocBuffer(AMF_MEMORY_HOST, 1024 * sizeof(float), &buffer);
...
TEST_F(Implementation, AMFData_Interop) {
	AMFBuffer* buffer;
	AMFBuffer* buffer_res;
	context1->AllocBuffer(AMF_MEMORY_HOST, 1024 * sizeof(float), &buffer);
...
TEST_F(Implementation, AMFBuffer_SetSize) {
	AMFBuffer* buffer;
	AMFBuffer* buffer_res;
	context1->AllocBuffer(AMF_MEMORY_HOST, 1024 * sizeof(float), &buffer);
...
TEST_F(Implementation, DISABLED_AMFSurface_SetCrop) {
	AMFSurface* surface;
...
TEST_F(Implementation, AMFComputeFactory_GetDeviceAt) {
	AMFComputeDevice* device;
	EXPECT_EQ(oclComputeFactory->GetDeviceAt(0, &device), AMF_OK);
	EXPECT_TRUE(device);
}

TEST_F(Implementation, AMFDeviceCompute_CreateCompute) {
	AMFComputeDevice* device;
...
TEST_F(Implementation, AMFDeviceCompute_CreateComputeEx) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
...
TEST_F(Implementation, AMFCompute_PutSyncPoint) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, AMFCompute_FlushQueue) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	EXPECT_EQ(device->CreateCompute(nullptr, &pCompute), AMF_OK);
...
TEST_F(Implementation, AMFCompute_FinishQueue) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_FillPlane) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, AMFCompute_FillBuffer) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_ConvertPlaneToBuffer) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
// TODO: Implement
TEST_F(Implementation, DISABLED_AMFCompute_CopyBuffer) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_CopyPlane) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, AMFCompute_CopyBufferToHost) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, AMFCompute_CopyBufferFromHost) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_CopyPlaneToHost) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_CopyPlaneFromHost) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFCompute_ConvertPlaneToPlane) {
	AMFComputeDevice* device;
	oclComputeFactory->GetDeviceAt(0, &device);
	AMFComputePtr pCompute;
	device->CreateCompute(nullptr, &pCompute);
...
TEST_F(Implementation, DISABLED_AMFComponent_Init) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_ReInit) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_Terminate) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_SubmitInput) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_QueryOutput) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_Drain) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_Flush) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_SetOutputDataAllocatorCB) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFComponent_GetCaps) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFCaps_GetInputCaps) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFCaps_GetOutputCaps) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFIOCaps_GetFormatAt) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFIOCaps_GetMemoryTypeAt) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFDataAllocatorCB_AllocBuffer) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}

TEST_F(Implementation, DISABLED_AMFDataAllocatorCB_AllocSurface) {
	EXPECT_NE(res, AMF_NOT_IMPLEMENTED);
}
